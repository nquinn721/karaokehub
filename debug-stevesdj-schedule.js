...
async function debugStevesdjSchedule() {
  ...
  try {
    ...
    const karaokeKeywords = ['karaoke', 'schedule', 'weekly', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday', 'venue', 'location', 'bar', 'restaurant'];
    ...
    const schedulePattern = /\b(monday|tuesday|wednesday|thursday|friday|saturday|sunday)\b.*?(\d{1,2}:\d{2}|\d{1,2}\s*(pm|am))/gi;
