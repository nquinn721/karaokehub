...
export class RenameKJsToDJs1755135477860 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE shows ADD CONSTRAINT FK_shows_dj FOREIGN KEY (djId) REFERENCES djs(id)`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE shows ADD CONSTRAINT FK_shows_kj FOREIGN KEY (kjId) REFERENCES djs(id)`,
    );
