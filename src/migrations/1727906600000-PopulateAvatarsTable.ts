...
export class PopulateAvatarsTable1727906600000 {
  ...
  public async up(dataSource: DataSource): Promise<void> {
    ...
    if (existingCount[0].count > 0) {
      console.log(
        `ℹ️  Avatars table already contains ${existingCount[0].count} records, skipping population`,
      );
      return;
    }
    ...
    console.log(
      `✅ Successfully populated avatars table with ${finalCount[0].count} default avatars`,
    );
