...
export class PopulateUserAvatars1737450600000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    // Create default avatar records for all existing users who don't have them
    await queryRunner.query(`
      INSERT INTO user_avatars (id, userId, baseAvatarId)
      SELECT
        UUID() as id,
        u.id as userId,
        'alex' as baseAvatarId
      FROM users u
