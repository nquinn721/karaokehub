...
import { ParserController, SimpleTestController, TestParserController } from './parser.controller';

@Module({
  imports: [TypeOrmModule.forFeature([Vendor, KJ, Show, ParsedSchedule])],
  controllers: [ParserController, TestParserController, SimpleTestController],
