    ...
    const microphones = [
      {
        ...
        imageUrl: '/assets/microphones/basic.png',
        price: 0,
        isAvailable: true,
        isUnlockable: false,
      },
      {
        ...
        imageUrl: '/assets/microphones/vintage.png',
        price: 50,
        isAvailable: true,
        isUnlockable: false,
      },
      {
        ...
        imageUrl: '/assets/microphones/modern-pro.png',
        price: 150,
        isAvailable: true,
        isUnlockable: false,
      },
      {
        ...
        imageUrl: '/assets/microphones/wireless.png',
        price: 300,
        isAvailable: true,
        isUnlockable: false,
      },
      {
        ...
        imageUrl: '/assets/microphones/golden.png',
        price: 0,
        isAvailable: true,
        isUnlockable: true,
