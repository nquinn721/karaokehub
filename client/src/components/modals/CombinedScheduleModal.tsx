import { faCalendarAlt, faTimes, faUser, faBuilding, faClock, faMapMarkerAlt } from '@fortawesome/free-solid-svg-icons';
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 0.5 }}>
                    ...
                    <Typography variant="body2" color="text.secondary" sx={{ lineHeight: 1.4 }}>
                      ...
                      {(show.city || show.state) && (
                        <Box component="span" sx={{ display: 'block', fontSize: '0.85em', opacity: 0.8 }}>
