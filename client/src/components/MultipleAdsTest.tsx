  ...
  return (
    <Box sx={{ p: 3, maxWidth: 1200, mx: 'auto' }}>
      ...
      <Typography variant="body1" sx={{ mb: 3 }}>
        This page tests multiple Adsterra ads loading simultaneously to verify the fix for
        single-ad-per-page limitation.
      </Typography>
      ...
      <Typography variant="body2" color="text.secondary">
        If the multiple ads fix is working correctly, you should see ads loading in all 5 positions
        above. Check the browser console for debugging information about ad loading.
      </Typography>
    </Box>
  );
};
