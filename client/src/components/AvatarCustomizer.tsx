...
const AVATAR_PARTS: AvatarPart[] = [
  // Microphones
  {
    ...
    category: 'microphone',
    imagePath: '/images/avatar/parts/microphones/basic.png',
    rarity: 'common',
    owned: true,
    zIndex: 100,
  },
  {
    ...
    category: 'microphone',
    imagePath: '/avatar/parts/microphones/wireless.png',
    rarity: 'rare',
    owned: true,
    zIndex: 100,
  },
  {
    ...
    category: 'microphone',
    imagePath: '/avatar/parts/microphones/vintage.png',
    rarity: 'epic',
    owned: false,
    price: 500,
    zIndex: 100,
  },
  {
    ...
    name: 'Neon LED Mic',
    category: 'microphone',
    imagePath: '/avatar/parts/microphones/neon.png',
    rarity: 'legendary',
    owned: false,
    price: 1000,
    zIndex: 100,
  },
  {
    ...
    category: 'microphone',
    imagePath: '/avatar/parts/microphones/studio.png',
    rarity: 'rare',
    owned: false,
    price: 300,
    zIndex: 100,
  },
  {
    ...
    category: 'microphone',
    imagePath: '/avatar/parts/microphones/ribbon.png',
    rarity: 'epic',
    owned: false,
    price: 600,
    zIndex: 100,
  },
  {
    ...
    category: 'microphone',
    imagePath: '/avatar/parts/microphones/crystal.png',
    rarity: 'legendary',
    owned: false,
    price: 1200,
    zIndex: 100,
  },
  {
    ...
    category: 'microphone',
    imagePath: '/avatar/parts/microphones/gold.png',
    rarity: 'legendary',
    owned: false,
    price: 1500,
    zIndex: 100,
  },
  {
    ...
    category: 'microphone',
    imagePath: '/avatar/parts/microphones/dynamic.png',
    rarity: 'common',
    owned: true,
    zIndex: 100,
  },
  {
    ...
    category: 'microphone',
    imagePath: '/avatar/parts/microphones/lavalier.png',
    rarity: 'rare',
    owned: false,
    price: 250,
    zIndex: 100,
  ...
  // Shirts
  {
    ...
    name: 'Casual T-Shirt',
    category: 'shirt',
    imagePath: '/avatar/parts/shirts/casual.png',
    rarity: 'common',
    owned: true,
    zIndex: 20,
  },
  {
    ...
    category: 'shirt',
    imagePath: '/avatar/parts/shirts/karaoke.png',
    rarity: 'rare',
    owned: true,
    zIndex: 20,
  },
  {
    ...
    category: 'shirt',
    imagePath: '/avatar/parts/shirts/sequin.png',
    rarity: 'epic',
    owned: false,
    price: 300,
    zIndex: 20,
  },
  {
    ...
    category: 'shirt',
    imagePath: '/avatar/parts/shirts/leather.png',
    rarity: 'legendary',
    owned: false,
    price: 750,
    zIndex: 20,
  ...
  // Pants
  {
    ...
    name: 'Classic Jeans',
    category: 'pants',
    imagePath: '/avatar/parts/pants/jeans.png',
    rarity: 'common',
    owned: true,
    zIndex: 10,
  },
  {
    ...
    name: 'Dress Pants',
    category: 'pants',
    imagePath: '/avatar/parts/pants/dress.png',
    rarity: 'rare',
    owned: true,
    zIndex: 10,
  },
  {
    ...
    category: 'pants',
    imagePath: '/avatar/parts/pants/glitter.png',
    rarity: 'epic',
    owned: false,
    price: 400,
    zIndex: 10,
  ...
  // Shoes
  {
    ...
    category: 'shoes',
    imagePath: '/avatar/parts/shoes/sneakers.png',
    rarity: 'common',
    owned: true,
    zIndex: 5,
  },
  {
    ...
    category: 'shoes',
    imagePath: '/avatar/parts/shoes/boots.png',
    rarity: 'rare',
    owned: false,
    price: 200,
    zIndex: 5,
  },
  {
    ...
    category: 'shoes',
    imagePath: '/avatar/parts/shoes/platform.png',
    rarity: 'legendary',
    owned: false,
    price: 600,
    zIndex: 5,
  ...
  // Hair
  {
    ...
    name: 'Natural Hair',
    category: 'hair',
    imagePath: '/avatar/parts/hair/default.png',
    rarity: 'common',
    owned: true,
    zIndex: 30,
  },
  {
    ...
    category: 'hair',
    imagePath: '/avatar/parts/hair/mohawk.png',
    rarity: 'epic',
    owned: false,
    price: 350,
    zIndex: 30,
  ...
  // Accessories
  {
    ...
    imagePath: '/avatar/parts/accessories/sunglasses.png',
    rarity: 'rare',
    owned: false,
    price: 150,
    zIndex: 50,
  },
  {
    ...
    category: 'accessories',
    imagePath: '/avatar/parts/accessories/hat.png',
    rarity: 'epic',
    owned: false,
    price: 250,
    zIndex: 40,
