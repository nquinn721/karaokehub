...
const defaultSEO: Required<SEOProps> = {
  ...
  description: 'Discover the best karaoke bars, venues, and singing spots in your area. Browse thousands of songs, connect with singers, find live karaoke shows, and unleash your inner performer.',
  keywords: [
    'karaoke', 'karaoke bars', 'singing', 'music venues', 'karaoke nights', 
    'live music', 'bars', 'pubs', 'entertainment', 'karaoke songs', 
    'vocal performance', 'nightlife', 'karaoke finder', 'singing venues', 
    'music entertainment', 'karaoke shows', 'live karaoke', 'karaoke events',
    'microphone', 'stage performance', 'karaoke machine', 'DJ', 'KJ'
  ],
...
export const seoConfigs = {
  home: {
    title: 'KaraokeHub - Find Karaoke Bars, Venues & Singing Spots Near You',
    description: 'Discover amazing karaoke venues, browse thousands of songs, and connect with fellow singers. Find live karaoke shows near you and unleash your inner performer!',
    keywords: ['karaoke finder', 'karaoke near me', 'karaoke bars', 'singing venues', 'live karaoke'],
    url: 'https://karaokehub.com',
    structuredData: {
  ...
  music: {
    ...
    description: 'Browse our massive library of karaoke songs from every genre and decade. Find popular karaoke hits, classic rock anthems, pop favorites, and hidden gems perfect for your next performance.',
    keywords: ['karaoke songs', 'karaoke tracks', 'song library', 'karaoke music', 'popular karaoke songs', 'karaoke hits', 'singing songs'],
  ...
  venues: {
    ...
    description: 'Discover the best karaoke venues, bars, and pubs in your area. Find live karaoke nights, open mic events, and singing competitions. See real-time schedules and venue information.',
    keywords: ['karaoke venues', 'karaoke bars near me', 'live karaoke', 'karaoke nights', 'singing bars', 'karaoke events', 'open mic nights'],
  ...
  dashboard: {
    ...
    description: 'Manage your karaoke experience with your personal dashboard. View favorite songs, connect with friends, track performance history, and discover new venues.',
    keywords: ['karaoke dashboard', 'my karaoke', 'favorite songs', 'karaoke profile', 'singing history'],
