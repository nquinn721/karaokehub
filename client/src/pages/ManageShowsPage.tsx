    ...
    >
      <Box sx={{ mb: 4 }}>
        <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
          <FontAwesomeIcon
            icon={faMusic}
            style={{ marginRight: '12px', fontSize: '32px', color: theme.palette.primary.main }}
          />
          <Box>
      ...
      {shows.length === 0 ? (
        <Card sx={{ backgroundColor: '#1e1e1e', color: '#ffffff' }}>
          <CardContent sx={{ textAlign: 'center', py: 6 }}>
            ...
            />
            <Typography variant="h5" sx={{ mt: 2, mb: 1, color: '#ffffff' }}>
              No Shows Found
            </Typography>
            <Typography variant="body1" sx={{ color: '#cccccc' }}>
              You don't have any shows scheduled yet. Contact your venue to get your shows added to
              the system.
            </Typography>
          </CardContent>
        </Card>
                    ...
                    {editingShow === show.id ? (
                      <FormControl size="small" sx={{ minWidth: 120 }}>
                        ...
                        <Select
                          ...
                          label="Day"
                          onChange={(event) => updateEditData(show.id, 'day', event.target.value)}
                        >
                  ...
                  <TableCell>
                    {editingShow === show.id ? (
                      ...
                      <Typography variant="body2">
                        {show.description || (
                          <em style={{ color: theme.palette.text.secondary }}>No description</em>
                        )}
                      </Typography>
                    )}
                  </TableCell>
