...
async function runDiagnostics() {
  ...
  try {
    ...
    if (envTest.status === 200 && envTest.data.environment) {
      ...
      console.log(`   Stripe Keys: ${envTest.data.environment.stripeAdFreePriceId ? 'Configured' : 'Missing'}`);
    }
  } catch (error) {
  ...
  console.log('   The system should detect invalid customer IDs and create new ones automatically.');
